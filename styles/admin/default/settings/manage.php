                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control time" name="setting[language]">
                                     <option value="az" <?php if ($item->language == 'az'): ?>selected<?php endif; ?>><?php echo lang('global_az') ?></option>
                                     <option value="tr" <?php if ($item->language == 'tr'): ?>selected<?php endif; ?>><?php echo lang('global_tr') ?></option>
                                     <option value="ru" <?php if ($item->language == 'ru'): ?>selected<?php endif; ?>><?php echo lang('global_ru') ?></option>
