        ...
        <div id="titlebar">
            <div class="container">
                <div class="special-block-bg">
                    ...
                    <nav id="breadcrumbs">
                        <ul>
                            <li><a href="<?php echo site_url("portfolio/$slug") ?>"><i class="pe-7s-home"></i> <?php echo lang('global_home') ?></a></li>
                            <li><a href="<?php echo site_url('blog/index/' . $slug) ?>"> <?php echo lang('global_Blog') ?></a></li>
                                        ...
                                        <div class="col-md-6 col-sm-12 blog-item">
                                            <div class="blog-article">
                                                ...
                                                <div class="article-content">
                                                    ...
                                                    <div class="meta"> <span><i><?php echo date('M', strtotime($post->datetime)) ?></i> <?php echo date('d, Y', strtotime($post->datetime)) ?></span> <span><i>In</i> <a href="<?php echo site_url('blog/category/' . $slug . '/' . $post->blog_category_id) ?>"><?php echo $post->category ?></a></span> </div>
                                                    <p>
                                                        <?php $this->load->helper('text') ?>
                            ...
                            <?php if (config('blog_search_wedgit') == 1): ?>
                                <div class="widget search-widget">
                                    ...
                                    <div class="search-blog-input">
                                        <form action="<?php echo site_url('blog/index/' . $slug) ?>">
                                            <div class="input">
                                                ...
                                                <li>
                                                    <div class="widget-content">
                                                        <div class="widget-thumb">
                                                            <a href="<?php echo site_url('post/' . $slug . '/' . $pop->blog_id . '-' . sanitize($pop->title)) ?>"><img src="<?php echo base_url() ?>/cdn/blog/<?php echo $pop->image ?>" alt="<?php echo $pop->title ?>"></a>
                                                        </div>
                                                        <div class="widget-text">
                                                            <h5>
                                                                <a href="<?php echo site_url('post/' . $slug . '/' . $pop->blog_id . '-' . sanitize($pop->title)) ?>">
                                                                    <?php $this->load->helper('text') ?>
                                ...
                                <div class="widget categories">
                                    ...
                                    <ul class="categories-list">
                                        <?php foreach ($categories as $cat): ?>
                                            <li>
                                                <a href="<?php echo site_url('blog/category/' . $slug . '/' . $cat->blog_category_id) ?>" <?php if ($category->blog_category_id == $cat->blog_category_id): ?> class="active" <?php endif ?>>
                                        ...
                                        <ul class="widget-tabs">
                                            <?php foreach ($latest_added as $latest): ?>
                                                <li>
                                                    <div class="widget-content">
                                                        <div class="widget-thumb">
                                                            <a href="<?php echo site_url('post/' . $slug . '/' . $latest->blog_id . '-' . sanitize($latest->title)) ?>"><img src="<?php echo base_url() ?>/cdn/blog/<?php echo $latest->image ?>" alt="<?php echo $latest->title ?>"></a>
                                                        </div>
                                                        <div class="widget-text">
                                                            <h5>
                                                                <a href="<?php echo site_url('post/' . $slug . '/' . $latest->blog_id . '-' . sanitize($latest->title)) ?>">
                                                                    <?php $this->load->helper('text') ?>
