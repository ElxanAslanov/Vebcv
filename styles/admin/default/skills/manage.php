    ...
    <div class="panel-body">
        ...
        <form role="form" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <?php echo form_dropdown('skill_category_id', dd2menu('skills_categories', array('skill_category_id' => 'title'), array("user_id" => session("user_id"))), set_value('skill_category_id', $item->skill_category_id), 'class="form-control"') ?>
                </div>
            </div>
