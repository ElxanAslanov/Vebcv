        ...
        <form role="form" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <?php echo form_dropdown('blog_category_id', dd2menu('blog_categories', $field = array('blog_category_id' => 'title'), $set_condition=array("user_id" => session("user_id")) ), set_value('blog_category_id', $item->blog_category_id), 'class="form-control"') ?>
