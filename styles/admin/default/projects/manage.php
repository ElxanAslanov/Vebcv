    ...
    <div class="panel-body">
        ...
        <form role="form" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <!--<?php echo form_dropdown('project_category_id', dd2menu('projects_categories', array('project_category_id' => 'title'), array("user_id", session("user_id"))), set_value('project_category_id', $item->project_category_id), 'class="form-control"') ?>-->
                    
                    
                    
                       <?php echo form_dropdown('project_category_id', dd2menu('projects_categories', array('project_category_id' => 'title'), array("user_id" => session("user_id"))), set_value('project_category_id', $item->blog_category_id), 'class="form-control"') ?>
