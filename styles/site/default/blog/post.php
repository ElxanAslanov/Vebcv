                ...
                <div class="special-block-bg">
                    ...
                    <nav id="breadcrumbs">
                        <ul>
                            ...
                            <li><a href="<?php echo site_url('blog/category/' . $slug . '/' . $item->blog_category_id) ?>"><?php echo $item->category ?></a></li>
                                ...
                                <div class="widget categories">
                                    ...
                                    <ul class="categories-list">
                                        <?php foreach ($categories as $cat): ?>
                                            <li>
                                                <a href="<?php echo site_url('blog/category/' . $slug . '/' . $cat->blog_category_id) ?>">
                                ...
                                <div class="widget tag">
                                    ...
                                    <div class="tagcloud">
                                        <?php foreach (explode(',', $item->meta_keywords) as $tag): ?>
                                            <a href="<?php echo site_url('blog/index/' . $slug . '?q=' . urlencode($tag)) ?>"><?php echo $tag ?></a>
                                        <?php endforeach ?>
                                    </div>
                                </div>
                            <?php endif ?>
