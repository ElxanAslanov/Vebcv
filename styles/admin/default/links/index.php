...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <div class="panel-options">
            <a href="<?php echo site_url('admin/links/add'); ?>" class="btn btn-secondary btn-sm"><i class="fa fa-plus-square" aria-hidden="true"></i>  <?php echo lang('global_add_new_record') ?></a>
        </div>
    </div>
    <div class="panel-body">
        ...
        <div class="table-responsive" data-pattern="priority-columns" data-focus-btn-icon="fa-asterisk" data-sticky-table-header="true" data-add-display-all-btn="true" data-add-focus-btn="true">
            <table cellspacing="0" class="table table-small-font table-bordered table-striped" >
                <thead>
                <tr>
                    <th> <?php echo lang('global_link_share') ?></th>
                    <th> <?php echo lang('global_links_main') ?></th>
                    <th> <?php echo lang('global_links_click') ?></th>
                ...
                <?php foreach ($links as $item): ?>
                    <tr id="<?php echo $item['id'] ?>">
                        <td><?php echo site_url().$user_slug."/go/".$item['link_key'] ?></td>
                        <td><?php echo $item['link'] ?></td>
                        <td><?php echo $item['click'] ?></td>

                        <td>
                            <a href="<?php echo site_url('admin/links/update/' . $item['id']); ?>" class="btn btn-orange btn-sm">
...
<script type="text/javascript">
    $(".remove").click(function(){
        ...
        {
            $.ajax({
                url: '<?php echo site_url() ?>admin/links/delete/'+id,
                type: 'DELETE',
                error: function() {
