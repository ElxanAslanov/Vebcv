            ...
            <div class="sidebar-menu toggle-others fixed">
                <div class="sidebar-menu-inner">
                    ...
                    <ul id="main-menu" class="main-menu">
                        <li>
                            <a href="<?php echo site_url("portfolio/" . session("slug")) ?>" target="_blank">
                                <i class="fa-medium"></i>
                                <span class="title"><?php echo lang('global_my_website') ?></span>
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#">
                                <i class="fa fa-tags"></i>
                                <span class="title"><?php echo lang('global_links_page') ?></span>
                            </a>
                            <ul>
                                <li>
                                    <a href="<?php echo site_url('admin/links') ?>">
                                        <i class="fa fa-sitemap"></i>
                                        <span class="title"><?php echo lang('global_links_page') ?></span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('admin/links/add') ?>">
                                        <i class="fa fa-tags"></i>
                                        <span class="title"><?php echo lang('global_links_add') ?></span>
                                    </a>
                                </li>
                            </ul>
                        </li>
...
<!--                            <strong><a href="--><?php //echo base_url()?><!--">--><?php //echo "portfoliom" ?><!--</a></strong>.-->
                        </div>
                        <div class="go-up">
                            <a href="#" rel="go-top">
