                ...
                <div class="col-md-6">
                    <div class="login-area commom-form-style">
                        ...
                        <div class="form-group">
                            ...
                            <!--placeholder -->
                            <!--<?php echo lang('global_email') ?>-->
                            
                            <input type="email" placeholder="E-poçtunuz" name="email" class="form-control" autocomplete="off" >
                        </div>

                        <div class="form-group">
                            
                              <!--placeholder -->
                            <!--<?php echo lang('global_password') ?>-->
                            
                            <input type="password" name="password" placeholder="Şifrəniz" class="form-control" autocomplete="off" >
                        </div>
                        <div class="form-group">
